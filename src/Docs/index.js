...
{title: "Syntax Guide | AbstractMark", description: "AbstractMark syntax guide, what to do, and what not to do", url:"syntax", code: syntax},
...
{title: "Python Implementation | AbstractMark", description: "Python Implementation of AbstractMark", url: "python-implementation", code: PY}]
export default docs;